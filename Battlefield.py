...
class Battlefield:
    ...
    def robo_turn(self):     #do i need (...robot?)
    ...
    def show_dino_opponent_oppositions(self):
        print(f'{self.herd.dinosaurs[0].name} has {self.herd.dinosaurs[0].health} health left!')
        print(f'{self.herd.dinosaurs[1].name} has {self.herd.dinosaurs[1].health} health left!')
        print(f'{self.herd.dinosaurs[2].name} has {self.herd.dinosaurs[2].health} health left!')

    def show_robo_opponent_oppositions(self):
        print(f'{self.fleet.robots[0].name} has {self.fleet.robots[0].health} health left!')
        print(f'{self.fleet.robots[1].name} has {self.fleet.robots[1].health} health left!')
        print(f'{self.fleet.robots[2].name} has {self.fleet.robots[2].health} health left!')
